<template>
    ...
    <div class="m-10 mx-auto p-16 sm:p-24 lg:p-48 bg-gray-200">
            ...
            >
                <div class="p-12 md:pr-24 md:pl-16 md:py-12">
                    <p class="text-gray-600">
                        ...
                        seamless checkout across mobile and web for customers
                        in 100+ countries, all while automatically combating
                        fraud.
                    </p>
                    <a
                        class="
        ...
        <div class="flex items-center pt-5 justify-between">
            ...
            <button
                class="px-2 opacity-100 hover:opacity-100 focus:opacity-100"
            >
                <img
                    class="w-full"
