                    ...
                    >
                        <div class="relative z-10 text-left">
                            ...
                            <form class="mt-6" @submit.prevent="signupstore.signUpPatient">
                                <div>
                                    <label
                                        class="block text-base font-medium leading-relaxed tracking-tighter textblueGray-900"
                                    >User Name</label>
                                    <input
                                        v-model="signupstore.data.username"
                                        type="text"
                                        id="username"
                                ...
                                <div class="flex flex-wrap mt-4 mb-6 -mx-3">
                                    <div class="w-full px-3 mb-6 md:w-1/2 md:mb-0">
                                        ...
                                        />
                                        <p
                                            class="mt-1 text-xs italic text-black"
                                ...
                                <div
                                    v-if="signupstore.signupStatus.accountAlreadyExist === true"
                                    class="flex my-0.5 content-center justify-center text-red-500"
                                >
                                    This email already exist and is associated
