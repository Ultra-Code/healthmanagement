<template>
    <!-- component -->
    <div class="max-w-full h-screen flex justify-center items-center">
        <div
            class="
                container
                mx-auto
        ...
        >
            ...
            >
                <img
                    class="w-full"
                    src="https://images.unsplash.com/photo-1627351030605-649122debb91?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=640&q=80"
                    alt="Profile image"
                />
